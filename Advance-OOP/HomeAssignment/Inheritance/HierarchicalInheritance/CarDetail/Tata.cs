...
public class Tata:CarInfo
{
    ...
    public Tata(string modelNumber,string modelName,string rcBookNumber,string engineNumber,string chasisNumber,double mileage,double tankCapacity,int numberOfSeats,double numberOfKmsDriven,DateTime dateOfPurchase):base(rcBookNumber,engineNumber,chasisNumber,mileage,tankCapacity,numberOfSeats,numberOfKmsDriven,dateOfPurchase){
        ModelNumber = modelNumber;
        ModelName = modelName;
    }

    public void ShowInfo(){
        System.Console.WriteLine("TATA MOTORS");
